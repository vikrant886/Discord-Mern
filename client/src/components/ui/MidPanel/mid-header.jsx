...
export default function Midheader() {
    ...
    //To fetch friends with their username
    ...
    return (
        (!homeclicked ?
            ...
            <div className="flex justify-center items-center w-full h-16">
                <div className="w-95">
                    <input type="text" className="p-0.8 w-full rounded-md text-xs bg-first text-text-three" placeholder="Search a Username" style={{ outline: 'none' }} onChange={(e) => setFinduser(e.target.value)} />
                </div>
            </div>
        )
    )
